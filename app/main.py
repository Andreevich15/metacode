...
admin_media_library = [
    {"label": "Web-разработка", "path": "/static/images/web.jpg"},
    {"label": "UML диаграммы", "path": "/static/images/uml.jpg"},
    {"label": "Нейросети", "path": "/static/images/ai.jpg"},
    {"label": "Базовый баннер", "path": "/static/images/site.jpg"},
]
...
async def admin_panel(request: Request):
    return templates.TemplateResponse(
        "admin.html",
        {
            ...
            "media_library": admin_media_library,
        },
    )
